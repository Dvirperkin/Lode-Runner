...
enum Sounds_t {COLLISION_ENEMY, COLLISION_COIN, LEVEL_FINISH, LOW_TIME};
enum Textures_t {PLAYER, STUPID_ENEMY_TEXT, RAND_ENEMY_TEXT, SMART_ENEMY_TEXT, WALL, COIN, LADDER, POLE, GIFT, STAGE_DETAILS, STAGE_BACKGROUND, MENU_BACKGROUND};
