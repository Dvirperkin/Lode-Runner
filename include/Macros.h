...
enum Sounds_t {WIN, GAME_OVER, LEVELUP, ENEMY_COLLISION, SYRINGE_SOUND, LOW_TIME, OPEN_CURTAIN,
               LIVE_GIFT_SOUND, SCORE_GIFT_SOUND, TIME_GIFT_SOUND, ENEMY_GIFT_SOUND};

enum Music_t {MAIN_MENU_MUSIC, STAGE_MUSIC};

enum Textures_t {PLAYER, STUPID_ENEMY_TEXT, RAND_ENEMY_TEXT, SMART_ENEMY_TEXT, WALL, COIN, LADDER,
                 POLE, GIFT, STAGE_DETAILS, STAGE_BACKGROUND, MENU_BACKGROUND, WIN_SCREEN};
...
const int FINISH_WAITING_TIME = 5;
const int NO_TIME = -1;
